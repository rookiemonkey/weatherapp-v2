...
An application that provides 5-day/7-day forecast against a given city. Consumes https://openweathermap.org/ api and  google's geocoder :sunny: :umbrella: :cloud:  - PS: my v1 is a mess so its on a private repo :joy:

Consider checking the repo's issues, all of my todos are in there :smile:

![Screenshot](./weatherappv21.png)
![Screenshot](./weatherappv22.png)
